...
class ActorNetwork(nn.Module):
    def __init__(self, state_dim, action_dim, action_low, action_high, hidden_size=64, discrete=False, activate_func=nn.ReLU()):  #mujoco是512
...
class CriticNetwork(nn.Module):
    def __init__(self, state_dim, hidden_size=64, activate_func=nn.ReLU()):
...
class PPO:
    ...
    def train(self, max_timesteps, smooth_window=100):
        ...
        self.plot_rewards(timesteps_list, episode_rewards, smoothed_rewards,
                          smooth_window)  # 《========================================
...
if __name__ == "__main__":
    ...
    for choose_env in choose_envs:
        if choose_env == "InvertedDoublePendulum":
            ...
            # 两层，relu，64神经元，Alien-ram-v0，Average reward over 100 episodes: 1220.9
            # 两层，relu，64神经元，Alien-ram-v4，Average reward over 100 episodes: 540.7
            # 两层tanh差不多，四层tanh    无改善
        elif choose_env == "Amidar":
            ppo = load_train("Amidar-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
            #ppo = load_train("Amidar-ram-v0", discrete=True, test_mark=test_mark, train_steps=10000)
        elif choose_env == "Assault":
            ppo = load_train("Assault-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
            #ppo = load_train("Assault-ram-v0", discrete=True, test_mark=test_mark, train_steps=10000)
        elif choose_env == "Asterix":
            ppo = load_train("Asterix-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env == "Asteroids":
            ppo = load_train("Asteroids-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env == "Atlantis":
            ppo = load_train("Atlantis-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="BankHeist":
            ppo = load_train("BankHeist-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="BattleZone":
            ppo = load_train("BattleZone-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env == "BeamRider":
            ppo = load_train("BeamRider-ram-v0", discrete=True, test_mark=test_mark,train_steps=4000000)
        elif choose_env == "Bowling":
            ppo = load_train("Bowling-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="Boxing":
            ppo = load_train("Boxing-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="Breakout":
            ppo = load_train("Breakout-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)


        elif choose_env == "NameThisGame":
            ppo = load_train("NameThisGame-ram-v0", discrete=True, test_mark=test_mark,train_steps=4000000)
        elif choose_env == "Pitfall":
            ppo = load_train("Pitfall-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="Pong":
            ppo = load_train("Pong-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="PrivateEye":
            ppo = load_train("PrivateEye-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)

        elif choose_env == "StarGunner":
            ppo = load_train("StarGunner-ram-v0", discrete=True, test_mark=test_mark,train_steps=4000000)

        elif choose_env == "Tennis":
            ppo = load_train("Tennis-ram-v0", discrete=True, test_mark=test_mark,train_steps=4000000)
        elif choose_env == "TimePilot":
            ppo = load_train("TimePilot-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="Tutankham":
            ppo = load_train("Tutankham-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)

        elif choose_env == "UpNDown":
            ppo = load_train("UpNDown-ram-v0", discrete=True, test_mark=test_mark,train_steps=4000000)
        elif choose_env == "Venture":
            ppo = load_train("Venture-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="VideoPinball":
            ppo = load_train("VideoPinball-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
        elif choose_env=="WizardOfWor":
            ppo = load_train("WizardOfWor-ram-v0", discrete=True, test_mark=test_mark, train_steps=4000000)
